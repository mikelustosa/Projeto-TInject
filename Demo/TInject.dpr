...
//  GlobalCEFApp.PathInjectJS         := 'C:\Componentes\WhatsApp\Repositorio\Demo\BIN\';            //<-  NOME do ARQUIVO INFORMADO
  //Forma 1 GlobalCEFApp.Pathxx         := '';                      //Irá procura procurar o Arquivo PADRAO no mesmo local do EXE
  //Forma 2 GlobalCEFApp.Pathxx         := 'C:\Componentes'; //<-  NOME do ARQUIVO INFORMADO

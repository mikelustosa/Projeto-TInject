    ...
    (function () {
        function getStore(modules) {
            ...
            let neededObjects = [
                ...
                { id: "Wap", conditions: (module) => (module.createGroup && !module.sendForNeededAddRequest) ? module : null },
				...
				{ id: "Time", conditions: (module) => (module.unixTime) ? module : null },
				{ id: "getEphemeralFields", conditions: (module) => (module.getEphemeralFields) ? module.getEphemeralFields : null },
                { id: "randomMessageId", conditions: (module) => (module.default && module.default.newId) ? module.default.newId : null },
                { id: "Wid", conditions: (module) => (module.default && module.default.isXWid) ? module.default : null },
            ...
            window.findModule = function (searchMod) {
                for (let idx in modules) {
                    if ((typeof modules[idx] === "object") && (modules[idx] !== null)) {
                        ...
                        const achei = keys.find(k => k.includes(searchMod));
                        if (achei) {
